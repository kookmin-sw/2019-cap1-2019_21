...
public class PubSubActivity extends Activity {
    ...
    private static final String CUSTOMER_SPECIFIC_ENDPOINT = "a28jgqlr4nhpzv-ats.iot.us-west-2.amazonaws.com";
    // Name of the AWS IoT policy to attach to a newly created certificate
    private static final String AWS_IOT_POLICY_NAME = "myfarmpolicy";
    ...
    private static final String topic = "$aws/things/my_farm/shadow/update";

    private static final String msgden1_on = "{ \"state\": { \"reported\": { \"den1\": \"on\" } } }";
    private static final String msgden1_off = "{ \"state\": { \"reported\": { \"den1\": \"off\" } } }";

    /*JSONObject desired = new JSONObject();
    desired put("setting_temper", "25");
